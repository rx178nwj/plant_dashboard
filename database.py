...
def migrate_db_schema(cursor):
    ...
    # Add soil_temperature1-4 and capacitance_ch1-4 columns to daily_plant_analysis
    analysis_new_columns = {
        ...
        'daily_soil_temp3_max': 'REAL',
        'daily_soil_temp3_min': 'REAL',
        'daily_soil_temp3_ave': 'REAL',
        'daily_soil_temp4_max': 'REAL',
        'daily_soil_temp4_min': 'REAL',
        'daily_soil_temp4_ave': 'REAL',
        'daily_capacitance_ch1_max': 'REAL',
        'daily_capacitance_ch1_min': 'REAL',
        'daily_capacitance_ch1_ave': 'REAL',
        'daily_capacitance_ch2_max': 'REAL',
        'daily_capacitance_ch2_min': 'REAL',
        'daily_capacitance_ch2_ave': 'REAL',
        'daily_capacitance_ch3_max': 'REAL',
        'daily_capacitance_ch3_min': 'REAL',
        'daily_capacitance_ch3_ave': 'REAL',
        'daily_capacitance_ch4_max': 'REAL',
        'daily_capacitance_ch4_min': 'REAL',
        'daily_capacitance_ch4_ave': 'REAL',
        'daily_ex_temperature_max': 'REAL',
        'daily_ex_temperature_min': 'REAL',
        'daily_ex_temperature_ave': 'REAL',
    }
